...
kf_dl  = 2.358223e+07*0.7;
nonspecific_correction = 1/7;

% from porschke1973
kf_zipping = 2.614e+08;
sliding_correction = 1;
k_fraying = 2e6;
kb_zipping = k_fraying;
...
kf_b.name = 'kf_b';
kb_b.value = 3.250175e+05*dangling_correction;
kb_b.name = 'kb_b';
